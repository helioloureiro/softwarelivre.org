...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="it" lang="it" class="controller-profile action-profile-content_tagged template-rightbar profile-type-is-person profile-name-is-marcelosoaressouza theme-sl-default">
  <head>
    <title>Marcelo</title>
    <link rel="alternate" type="application/rss+xml" title="Marcelo Soares Souza&#39;s contents tagged with &quot;x.org&quot;" href="/profile/marcelosoaressouza/tags/x.org/feed" />
...
jQuery(document).ready(function () {
  ...
  <body class="controller-profile action-profile-content_tagged template-rightbar">
...
<form action="/account/login" accept-charset="UTF-8" method="post"><input name="utf8" type="hidden" value="&#x2713;" /><input type="hidden" name="authenticity_token" value="UoHbsnmOF3l5QzcYh7AtRXOGq30nt9K5Swy412pGAuLP6WuzC9UVmpZYwoYBMFcmPBdhvi87FesWgIHTNc2kMA==" />
...
<div class="profile-info-options">
  <ul>
    ...
    <div class="block-outer"><div class="block link-list-block" id="block-3549" help="This block can be used to create a menu of links. You can add, remove and update the links as you wish."><div class="block-inner-1"><div class="block-inner-2"><div class="block-header"><h3 class="block-title empty"><span></span></h3><h4 class="block-subtitle empty"><span></span></h4></div>
...
<h1>Content tagged with &quot;x.org&quot;</h1>

<p>
<a class="blog-feed-link" href="/profile/marcelosoaressouza/tags/x.org/feed"><img alt="Feed for this tag" title="Feed for this tag" src="/images/icons-mime/rss-feed.png" /></a>
</p>

  <div class='search-tagged-items'>
    <ul>
      <li><a href="http://softwarelivre.org/marcelosoaressouza/blog-do-marcelo-soares-souza/disponibilizado-o-snapshot-de-desenvolvimento-do-x.org-1.12">Disponibilizado o snapshot de desenvolvimento do X.Org 1.12</a></li>
      <li><a href="http://softwarelivre.org/marcelosoaressouza/blog-do-marcelo-soares-souza/x-server-1.13">X Server 1.13</a></li>
    </ul>
  </div>
  ...
  <div>
    <a href="/tag/x.org">See content tagged with "x.org" in the entire site</a>
  </div>
</div></div></div></div></div>
