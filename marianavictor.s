...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="pt" lang="pt" class="controller-profile action-profile-index template-default profile-type-is-person profile-name-is-marianavictor.s theme-sl-default">
  <head>
    <title>Mari Victor</title>
...
<link rel="stylesheet" media="screen" href="/assets/designs/themes/sl-default/style-f317a60b59d0ee3e8048cb6eba54b282.css" />
    ...
    <script type="text/javascript">
      ...
      noosfero.profile = "marianavictor.s"
    </script>
...
<form action="/account/login" accept-charset="UTF-8" method="post"><input name="utf8" type="hidden" value="&#x2713;" /><input type="hidden" name="authenticity_token" value="Cwo+fktxuBLu87olXFMjZZrnpfvbVnRWjbfaZonN2zOWYo5/OSq68QHoT7va01kG1XZvONPaswTQO+Ni1kZ94Q==" />
...
<ul>
  ...
  <div id="profile-header"></div><div class="boxes" id="boxes"><div class="box box-3" id="box-62283"><div class="blocks">    <div class="block-outer"><div class="block friends-block" id="block-118657" help="Clicando em um amigo você será enviado a página inicial dele"><div class="block-inner-1"><div class="block-inner-2">
<div class="block-header"><h3 class="block-title"><span>0 amigos</span></h3><h4 class="block-subtitle empty"><span></span></h4></div>

<div>
    <div class="common-profile-list-block-none">Nenhum(a)</div>
  <br style="clear:both" />
</div>
<div class="block-footer-content"><a class="view-all" href="/profile/marianavictor.s/friends">Ver todos</a>

</div></div></div></div></div>

    <div class="block-outer"><div class="block communities-block" id="block-118658" help="Este bloco exibe as comunidades das quais o usuário é membro."><div class="block-inner-1"><div class="block-inner-2"><div class="block-header"><h3 class="block-title"><span>0 comunidades</span></h3><h4 class="block-subtitle empty"><span></span></h4></div>
...
<br style='clear:both'/>
<div class="block-footer-content">    <a class="view-all" href="/profile/marianavictor.s/communities">Ver todas</a>

</div></div></div></div></div>
</div></div>
<div class="box box-2" id="box-62282"><div class="blocks">  <div class="block-outer"><div class="block profile-image-block" id="block-118655" help="Este bloco apresenta a imagem do perfil"><div class="block-inner-1"><div class="block-inner-2"><div class="vcard">


<div class="profile-big-image img-pic">
  <div class="profile-big-image-inner1">
    <div class="profile-big-image-inner2">
      <a href="http://softwarelivre.org/marianavictor.s"><img alt="Mariana Victor da Silva" title="" class=" photo" src="//www.gravatar.com/avatar/0f4d7da380a01b302848dba84abcfad5?only_path=false&amp;size=150&amp;d=wavatar" />
</a>
    </div>
  </div>
</div>
...
<div class="profile-info-options">
  <ul>
    ...
    <div class="block-outer"><div class="block link-list-block" id="block-118656" help="Este bloco pode ser usado para criar um menu de links. Você pode incluir, remove e atualizar links como quiser."><div class="block-inner-1"><div class="block-inner-2"><div class="block-header"><h3 class="block-title empty"><span></span></h3><h4 class="block-subtitle empty"><span></span></h4></div>



<ul>
    <li>
      <a class="icon-menu-people" href="/profile/marianavictor.s">Perfil</a>
    </li>
    <li>
      <a class="icon-send" href="/profile/marianavictor.s/invite/friends">Convide amig@s</a>
    </li>
    <li>
      <a class="icon-photos" href="/marianavictor.s/galeria">Galeria de fotos</a>
    </li>
    <li>
      <a class="icon-menu-events" href="/profile/marianavictor.s/events">Agenda</a>
    </li>
    <li>
      <a class="icon-edit" href="/marianavictor.s/blog">Blog</a>
    </li>
</ul>
</div></div></div></div>
</div></div>
<div class="box box-1" id="box-62281"><div class="blocks">  <div class="block-outer"><div class="block main-block" id="block-118654" help="Este bloco apresenta o conteúdo principal das suas páginas."><div class="block-inner-1"><div class="block-inner-2"><div class="main-content"><h1>Mariana Victor da Silva</h1>

  <div id='public-profile-search'>
    <form class="search_form" action="/profile/marianavictor.s/search" accept-charset="UTF-8" method="post"><input name="utf8" type="hidden" value="&#x2713;" /><input type="hidden" name="_method" value="data-remote" /><input type="hidden" name="authenticity_token" value="U662BRjBwc1k3X41O0PYrfVgytFPt94XO3Jg++VpJSvOxgYEaprDLovGi6u9w6LOuvEAEkc7GUVm/ln/uuKD+Q==" />
  <div class="search-field">
    <span class="formfield">
      <input type="text" name="q" id="q" title="Buscar no conteúdo de Mari Victor" placeholder="Buscar no conteúdo de Mari Victor" class="search-input-with-suggestions" data-asset="articles" />
    </span>
    
    <input type="submit" name="commit" value="Busca" class="button with-text icon-search submit" />
    <div>
      <input type="radio" name="where" id="radio-496" value="profile" title="Buscar no conteúdo de Mari Victor" checked="checked" /><label for="radio-496">Mari Victor</label>
      <input type="radio" name="where" id="radio-497" value="environment" title="Buscar todo o conteúdo" /><label for="radio-497">Geral</label>
    </div>
  </div>
</form>
  </div>
  ...
  <table class='profile'>
    <tr>
      <td colspan='2'>
        ...
        <div class="ui-tabs"><ul><li class="tab"><a href="#person-profile">Perfil</a></li></ul><div id="person-profile"><table>
  <tr><th colspan="2">Informação básica</th></tr><tr><td class="field-name">Configurações de privacidade</td><td>Perfil público</td></tr><tr><td class="field-name">Perfil criado em</td><td>8 de Junho de 2011</td></tr>
  
  

    
    
    <tr><th colspan="2">Rede</th></tr><tr><td class="field-name">Amigos</td><td><a href="/profile/marianavictor.s/friends">1</a></td></tr><tr><td class="field-name">Seguidores</td><td><a href="/profile/marianavictor.s/followed">1</a></td></tr><tr><td class="field-name">Seguindo</td><td><a href="/profile/marianavictor.s/following">1</a></td></tr>

        <tr><th colspan="2">Conteúdo</th></tr><tr><td class="field-name">Blogs</td><td><a href="http://softwarelivre.org/marianavictor.s/blog">0 posts</a></td></tr><tr><td class="field-name">Galeria</td><td><a href="http://softwarelivre.org/marianavictor.s/galeria">0 fotos</a></td></tr>
