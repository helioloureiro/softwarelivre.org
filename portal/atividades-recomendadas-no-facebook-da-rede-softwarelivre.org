...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="pt" lang="pt" class="controller-content_viewer action-content_viewer-view_page template-default profile-type-is-community profile-name-is-portal theme-sl-default">
  <head>
    <title>Atividades recomendadas no facebook da rede SoftwareLivre.org - PSL Brasil</title>
...
<form action="/account/login" accept-charset="UTF-8" method="post"><input name="utf8" type="hidden" value="&#x2713;" /><input type="hidden" name="authenticity_token" value="FEcXJveoV7MY3oa9bA73XlSdIi3fN3u3eEvHUtgvKMhaQ3RB50FSUiuISphGp2cVJybv/fJ2eswDot/Uk7DCFw==" />
...
<div id="article-toolbar">
  ...
  <div id="article-header">
      ...
      <h1 class="title">
    Atividades recomendadas no facebook da rede SoftwareLivre.org
  </h1>
  <span class="publishing-info">
  <span class="date">
    21 de Março de 2012, 0:00
  </span>
  <span class="author">
    , por Valessio Brito
  </span>
...
|
  ...
  <div class="article-body article-body-text-article">
    <h2>Botão curtir e recomendações</h2>
<p>
Você pode a qualquer momento recomendar um artigo da nossa rede em outras plataformas através dos botões sociais AddThis, você pode também "curtir" a fanpage <a href="https://www.facebook.com/PSLBrasil">PSL-Brasil</a> e acompanhar as atualizações da nossa rede dentro do facebook.
</p>
<div id="fb-root"></div>
<script>(function(d, s, id) {
  ...
  js.src = "//connect.facebook.net/pt_BR/all.js#xfbml=1&appId=166214416789477";
  fjs.parentNode.insertBefore(js, fjs);
}(document, 'script', 'facebook-jssdk'));</script>
<div class="fb-like" data-href="https://www.facebook.com/PSLBrasil" data-send="true" data-width="498" data-show-faces="true"></div>
<p>

</p>
<h2>Artigos recomendados</h2>
<iframe src="//www.facebook.com/plugins/activity.php?site=http%3A%2F%2Fwww.softwarelivre.org&amp;action&amp;width=498&amp;height=1000&amp;header=false&amp;colorscheme=light&amp;linktarget=_blank&amp;border_color&amp;font&amp;recommendations=true&amp;appId=274595792606026" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:498px; height:1000px;" allowtransparency="true"></iframe>
    <br style="clear:both" />
  </div> <!-- end class="article-body" -->



<div id="article-source">Fonte: <a href="http://softwarelivre.org/comunicacao/atividades-no-facebook-sobre-a-rede-softwarelivre.org">Comunicação</a></div>
