...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="pt" lang="pt" class="controller-content_viewer action-content_viewer-view_page template-leftbar profile-type-is-community profile-name-is-anunciantes theme-sl-default">
  <head>
    <title>Anuncie no SoftwareLivre.org! - Anunciantes</title>
...
jQuery(document).ready(function () {
  ...
  <body class="controller-content_viewer action-content_viewer-view_page template-leftbar">
    ...
    <meta name="profile.allow_unauthenticated_comments" />
...
<form action="/account/login" accept-charset="UTF-8" method="post"><input name="utf8" type="hidden" value="&#x2713;" /><input type="hidden" name="authenticity_token" value="c4DfuhbsxfpbyYBUbD1sf8lK0oNwQYRdGH/+lksbZBzu6G+7ZLfHGbTSdcrqvRYchtsYQHjNQw9F88eSFJDCzg==" />
...
<ul>
  ...
  <div id="profile-header"><div><a title="Página para anunciantes" href="/articles/0134/2097/banner-anuncios.png" alt=""></a></div></div><div class="boxes" id="boxes"><div class="box box-2" id="box-321721"><div class="blocks">    <div class="block-outer"><div class="block link-list-block" id="block-557707" help="Este bloco pode ser usado para criar um menu de links. Você pode incluir, remove e atualizar links como quiser."><div class="block-inner-1"><div class="block-inner-2"><div class="block-header"><h3 class="block-title empty"><span></span></h3><h4 class="block-subtitle empty"><span></span></h4></div>



<ul>
    <li>
      <a target="_self" class="icon-no-icon" href="/anunciantes/visao-geral">Visão Geral</a>
    </li>
    <li>
      <a target="_self" class="icon-no-icon" href="/anunciantes/tipos-de-anuncios">Tipos de Anúncios</a>
    </li>
    <li>
      <a target="_self" class="icon-no-icon" href="/anunciantes/anuncie-no-softwarelivre.org">Seja um Anunciante!</a>
    </li>
</ul>
</div></div></div></div>

    <div class="block-outer"><div class="block raw-html-block" id="block-625503"><div class="block-inner-1"><div class="block-inner-2"><div class="block-header"><h3 class="block-title empty"><span></span></h3><h4 class="block-subtitle empty"><span></span></h4></div>
...
#content .link-list-block li:hover {
...
<div class="box box-1" id="box-321720"><div class="blocks">  <div class="block-outer"><div class="block main-block" id="block-557705" help="Este bloco apresenta o conteúdo principal das suas páginas."><div class="block-inner-1"><div class="block-inner-2"><div class="main-content">
...
<div id="article-toolbar">
  ...
  <div id="article-header">
      ...
      <h1 class="title">
    Anuncie no SoftwareLivre.org!
  </h1>
  <span class="publishing-info">
  <span class="date">
    10 de Abril de 2014, 11:09
  </span>
  <span class="author">
    , por Daniela Feitosa
  </span>
...
|
  ...
  <div class="article-body article-body-text-article">
    Faça seu anúncio no portal SoftwareLivre.org!
<br><br>
Fale com um público qualificado e formador de opinião e contribua para a sustentabilidade tecnológica e financeira desse serviço de rede social oferecido pela ASL.
<br><br>
Os anúncios devem seguir a Política Editorial do portal.
<br><br>
Informe sobre o tipo de anúncio que deseja fazer e dê algumas informações sobre o produto e/ou serviço anunciado. Entraremos em contato para mais informações.
<br><br>


<h3>Entre em contato</h3>

<p>Os preços e condições dos anúncios no SoftwareLivre.org consideram as boas práticas de negociações e interações. Entre em contato através do formulário abaixo ou por email <strong>anuncios-sl@colivre.coop.br</strong>.</p>

(<em>Os campos em vermelho são obrigatórios.</em>)
...
<style type="text/css" media="screen">
  ...
  .anuncios-form label.required,
  .anuncios-form span.required {
    color: #CC0000;
    font-weight: bold;
  }
  .anuncios-form input.required {
    border: 2px solid #CC0000;
  }
  .anuncios-form label.required {
    display: inline-block;
  }
  .anuncios-form .formfield input {
    font-size: 15px;
    height: 25px;
    padding: 5px 0;
    width: 400px;
  }
  .anuncios-form .formfield textarea {
    width: 400px;
  }
</style>
...
<script type="text/javascript">
  jQuery(function($) {
    ...
    $("form.anuncios-form").live('submit', function(data) {
      var valid = true;
      ...
      $(".required").each( function(index) {
        ...
        if ($(input).val() == "") {
          valid = false;
          display_notice('O campo ' + $(this).html() + ' precisa ser preenchido');
...
<form class="anuncios-form" action="/profile/anunciantes/plugin/send_email/deliver" method="post">
  <img src="/portal/anuncios/padroes/banner-120x180.png">
  <input type="hidden" name="to" value="anuncios-sl@colivre.coop.br">
  <input type="hidden" name="subject" value="Anúncio no SoftwareLivre.org">
  <div class="formfieldline">
    <label class="formlabel required" for="anuncios_nome">Nome do Anunciante</label>
    <div class="formfield type-text"><input id="anuncios_nome" name="Nome" size="40" type="text"></div>
  </div>
  <div class="formfieldline">
    <label class="formlabel required" for="anuncios_email">e-mail de contato</label>
    <div class="formfield type-text"><input id="anuncios_email" name="email" size="40" type="text"></div>
  </div>

  <div class="formfieldline">
    <label class="formlabel" for="anuncios_telefone">Telefone para contato</label>
    <div class="formfield type-text"><input id="anuncios_telefone" name="telefone" size="40" type="text"></div>
  </div>

    <label class="formlabel required" for="anuncios_message">Informações sobre o anúncio</label>
    <div class="formfield type-textarea"><textarea rows="20" name="message" id="anuncios_message" cols="40"></textarea></div>

  <div class="button-bar">
    <input class="button with-text icon-send submit" name="commit" value="Enviar" type="submit">
    <br style="clear: left;">
  </div>
</form>
    <br style="clear:both" />
