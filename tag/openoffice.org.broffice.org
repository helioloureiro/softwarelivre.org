...
<form action="/account/login" accept-charset="UTF-8" method="post"><input name="utf8" type="hidden" value="&#x2713;" /><input type="hidden" name="authenticity_token" value="iPl/aXp+b1e3zaiIaVH1jg8TkEOQORfXhC0W1ZXyINAVkc9oCCVttFjWXRbv0Y/tQIJagJi10IXZoS/RynmGAg==" />
...
<div class="search-field">
  ...
  <div>
    <a class="search-result-title" href="http://softwarelivre.org/furusho/blog/fedora-15-lovelock-e-lancado-ja-vem-com-o-libreoffice">Fedora 15 Lovelock é Lançado, já vem com o LibreOffice</a>
  </div>
...
<tr class="search-article-description">
  <td class="search-field-label">Descrizione</td>
    ...
    <td class="search-article-body">O Fedora 15 Lovelock já está liberado para seus users fazerem download. Ele traz o ambiente desktop GNOME 3, suporte melhorado no momento da instalação do sistema de arquivos Btrfs, maior refinamento no...</td>
</tr>

<tr class="search-article-tags">
  <td class="search-field-label">Tags</td>
  <td class="search-article-tags-container ">
      <a class="search-article-tag" href="/tag/firefox">firefox</a>
      <a class="search-article-tag" href="/tag/furusho">furusho</a>
      <a class="search-article-tag" href="/tag/openoffice.org.broffice.org">openoffice.org.broffice.org</a>
