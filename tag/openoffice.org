...
<form action="/account/login" accept-charset="UTF-8" method="post"><input name="utf8" type="hidden" value="&#x2713;" /><input type="hidden" name="authenticity_token" value="AqTPc8HoyoizxpCao+6BBq81OJFLyc1UF4pendZ6Bg6fzH9ys7PIa1zdZQQlbvtl4KTyUkNFCgZKBmeZifGg3A==" />
...
<ul>
  ...
  <h1>Search Results - <small>Tagged with openoffice.org</small></h1>
  <div id='search-header'>
  <ul id="assets-menu"><li><a data-tag="openoffice.org" href="/search/articles">Contents</a></li>
...
<div class="search-field">
  ...
  <div class="map-or-list-search-results list"><div id="search-results" class="multiple-results-boxes">
    ...
    <div class="search-results-articles search-results-box ">
          ...
          <h3>Contents</h3>
            <a class="see-more" href="/search/articles?tag=openoffice.org">see all (33)</a>
