...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="eo" lang="eo" class="controller-profile action-profile-index template-leftbar profile-type-is-community profile-name-is-broffice.org theme-sl-default">
  <head>
    <title>BrOffice.org</title>
...
jQuery(document).ready(function () {
  ...
  <body class="controller-profile action-profile-index template-leftbar">
...
<form action="/account/login" accept-charset="UTF-8" method="post"><input name="utf8" type="hidden" value="&#x2713;" /><input type="hidden" name="authenticity_token" value="VG66gyS2Oq9+LB8WjbGg8x0gbKpKlpuKxM0hWP22jWnJBgqCVu04TJE36ogLMdqQUrGmaUIaXNiZQRhcoj0ruw==" />
...
<ul>
  ...
  <div id="profile-header"></div><div class="boxes" id="boxes"><div class="box box-2" id="box-33140"><div class="blocks">  <div class="block-outer"><div class="block profile-image-block" id="block-62451" help="This block presents the profile image"><div class="block-inner-1"><div class="block-inner-2"><div class="vcard">


<div class="profile-big-image img-pic">
  <div class="profile-big-image-inner1">
    <div class="profile-big-image-inner2">
      <a href="http://softwarelivre.org/broffice.org"><img alt="BrOffice.org" title="" class=" logo" src="/image_uploads/0003/0883/BrOffice.org_big.png" />
</a>
    </div>
  </div>
</div>
...
<div class="profile-info-options">
  ...
  <li>
    ...
    <a class="button icon-add with-text modal-toggle join-community" title="Join this community" href="/profile/broffice.org/join_not_logged">&nbsp;<span>Join this community</span></a>
</div>

<script>
//<![CDATA[

  noosfero.add_and_join.locales.leaveConfirmation = "Please confirm to leave the community 'BrOffice.org'"
...
//]]>
    ...
    <div class="block-outer"><div class="block link-list-block" id="block-62452" help="This block can be used to create a menu of links. You can add, remove and update the links as you wish."><div class="block-inner-1"><div class="block-inner-2"><div class="block-header"><h3 class="block-title empty"><span></span></h3><h4 class="block-subtitle empty"><span></span></h4></div>



<ul>
    <li>
      <a class="icon-ok" href="/profile/broffice.org">Página inicial</a>
    </li>
    <li>
      <a class="icon-menu-events" href="/profile/broffice.org/events">Agenda</a>
    </li>
    <li>
      <a class="icon-edit" href="/broffice.org/blog">Blog</a>
    </li>
</ul>
</div></div></div></div>

    <div class="block-outer"><div class="block recent-documents-block" id="block-62453" help="This block lists your content most recently updated."><div class="block-inner-1"><div class="block-inner-2"><div class="block-header"><h3 class="block-title"><span>Recent content</span></h3><h4 class="block-subtitle empty"><span></span></h4></div>

<ul>
    <li><a href="http://softwarelivre.org/broffice.org/viii-congresso-internacional-de-linguagem-e-tecnologia-online">VIII Congresso Internacional de Linguagem e Tecnologia online</a></li>
    <li><a href="http://softwarelivre.org/broffice.org/xi-encontro-virtual-de-documentacao-em-software-livre-e-viii-congresso-internacional-de-linguagem-e-tecnologia-online">XI Encontro Virtual de Documentação em Software Livre e VIII Congresso Internacional de Linguagem e Tecnologia online</a></li>
</ul>
<div class="block-footer-content">  <a href="/profile/broffice.org/sitemap">All content</a>
</div></div></div></div></div>
</div></div>
<div class="box box-1" id="box-33139"><div class="blocks">  <div class="block-outer"><div class="block main-block" id="block-62450" help="This block presents the main content of your pages."><div class="block-inner-1"><div class="block-inner-2"><div class="main-content"><h1>BrOffice.org</h1>

  <div id='public-profile-search'>
    <form class="search_form" action="/profile/broffice.org/search" accept-charset="UTF-8" method="post"><input name="utf8" type="hidden" value="&#x2713;" /><input type="hidden" name="_method" value="data-remote" /><input type="hidden" name="authenticity_token" value="tC3Zsl37h+DBdBBL0/A2MRo34rrQ7WqdfOQzVQNIK/UpRWmzL6CFAy5v5dVVcExSVaYoedhhrc8haApRXMONJw==" />
  <div class="search-field">
    <span class="formfield">
      <input type="text" name="q" id="q" title="Find in BrOffice.org&#39;s content" placeholder="Find in BrOffice.org&#39;s content" class="search-input-with-suggestions" data-asset="articles" />
    </span>
    
    <input type="submit" name="commit" value="Search" class="button with-text icon-search submit" />
    <div>
      <input type="radio" name="where" id="radio-12" value="profile" title="Find in BrOffice.org&#39;s content" checked="checked" /><label for="radio-12">BrOffice.org</label>
      <input type="radio" name="where" id="radio-13" value="environment" title="Search all content" /><label for="radio-13">General</label>
    </div>
  </div>
</form>
  </div>
  ...
  <table class='profile'>
    <tr>
      <td colspan='2'>
        ...
        <div class="ui-tabs"><ul><li class="tab"><a href="#organization-profile">Profile</a></li></ul><div id="organization-profile"><table>
  <tr><th colspan="2">Basic information</th></tr><tr><td class="field-name">Profile created at</td><td>La 29-a de junio 2010</td></tr><tr><td class="field-name">Type</td><td>Community</td></tr><tr><td class="field-name">Members</td><td><a href="/profile/broffice.org/members">15</a></td></tr><tr><td class="field-name">Admins</td><td><a href="http://softwarelivre.org/rocheleprass">Rochele Prass</a></td></tr>
  
  
      <tr><th colspan="2">Content</th></tr><tr><td class="field-name">Blogs</td><td><a href="http://softwarelivre.org/broffice.org/blog">0 posts</a></td></tr><tr><td class="field-name">Events</td><td><a href="/profile/broffice.org/events">2</a></td></tr>
