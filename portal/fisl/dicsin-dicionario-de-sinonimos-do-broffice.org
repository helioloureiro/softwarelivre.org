...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="pt" lang="pt" class="controller-content_viewer action-content_viewer-view_page template-default profile-type-is-community profile-name-is-portal theme-sl-default">
  <head>
    <title>DicSin - Dicionário de Sinônimos do BrOffice.org - PSL Brasil</title>
    <link rel="alternate" type="application/rss+xml" title="FISL" href="http://softwarelivre.org/portal/fisl/feed" />
...
<form action="/account/login" accept-charset="UTF-8" method="post"><input name="utf8" type="hidden" value="&#x2713;" /><input type="hidden" name="authenticity_token" value="x5owzwY4mlw6SwPNfSJUMPpCyU1YglDBAlHnb9+B2fha8oDOdGOYv9VQ9lP7oi5TtdMDjlAOl5Nf3d5rgAp/Kg==" />
...
<a style="font-size: 9px;top: -3px;" title="29 itens" href="http://softwarelivre.org/profile/portal/tags/campus%20party">campus party</a>
...
<script type="text/javascript">
  ...
  <div id="article-parent">
    <a class="button icon-back with-text" title="Go back to FISL" href="http://softwarelivre.org/portal/fisl">&nbsp;<span>Go back to FISL</span></a>
  </div>
...
|
  ...
  <div id="article-tags">
    This article's tags:
    <a href="/profile/portal/tags/fisl2002">fisl2002</a>
  </div>

<div id="article-source">Source: <a href="http://softwarelivre.org/furusho/blog/dicsin-dicionario-de-sinonimos-do-broffice.org">Vitorio Furusho</a></div>
